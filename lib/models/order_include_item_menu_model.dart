...
//
//     final orderMeIncludeItemMenuModel = orderMeIncludeItemMenuModelFromJson(jsonString);

import 'dart:convert';

OrderMeIncludeItemMenuModel orderMeIncludeItemMenuModelFromJson(String str) =>
    OrderMeIncludeItemMenuModel.fromJson(json.decode(str));

String orderMeIncludeItemMenuModelToJson(OrderMeIncludeItemMenuModel data) =>
    json.encode(data.toJson());

class OrderMeIncludeItemMenuModel {
  OrderMeIncludeItemMenuModel({
    this.id,
    this.number,
    this.pax,
    this.type,
  ...
  factory OrderMeIncludeItemMenuModel.fromJson(Map<String, dynamic> json) =>
      OrderMeIncludeItemMenuModel(
        id: json["id"],
        number: json["number"],
        pax: json["pax"],
